========================================================================
    APLICACIÓN DE CONSOLA: BubbleProtocolWindows Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación BubbleProtocolWindows.

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación BubbleProtocolWindows.


BubbleProtocolWindows.vcxproj
...
BubbleProtocolWindows.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Estos archivos se usan para compilar un archivo de encabezado precompilado (PCH) denominado BubbleProtocolWindows.pch y un archivo de tipos precompilados llamado StdAfx.obj.
